"""Repositorio Supabase — mesma interface de JsonListRepository."""
from __future__ import annotations

from typing import Callable, Optional

from .supabase_store import load_collection, persist_state
...
class SupabaseListRepository:
    ...
    def reload(self):
        setattr(self._app, self._key, load_collection(self._key))


def reload_all(app):
    from ..storage import STATE_KEYS
    from .supabase_store import load_state_dict
