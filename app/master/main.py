...
from .middleware.tracking_host import TrackingHostMiddleware
...
from .routers.web.media import router as media_router
...
from .routers.web.geolocator import router as geolocator_router
from .routers.public.tracking_public import router as tracking_public_router
...
def create_master_app(runtime_app) -> FastAPI:
    ...
    app.add_middleware(TrackingHostMiddleware)
    app.add_middleware(
        SessionMiddleware,
    ...
    app.include_router(tracking_public_router)
    return app
